...
| [Amazon Image Auto](usecases/amazon-image-auto.md) | Upload raw product photos from multiple angles — AI reconstructs the 3D shape, renders any camera angle, drops the product into lifestyle scenes, and exports the full Amazon A+ image suite automatically. |
